...
import ImprovedThreatModelingForm from './ImprovedThreatModelingForm';
...
const MissingInputsForm = ({ missingInputs, onSubmit }) => {
  ...
  const isThreatModeling = Object.keys(missingInputs).includes('threat_modeling_and_test_plan_generation');
  ...
  {isThreatModeling ? (
  <ImprovedThreatModelingForm 
    onSubmit={(threatModelingData) => {
      // Log the data to verify
      console.log("Received threat modeling data from form:", threatModelingData);
      
      // Create a simplified input object with just the necessary fields
      const inputs = {
        asset_list: threatModelingData.asset_list,
        threat_modeling_answers: threatModelingData.threat_modeling_answers,
        verification_answers: threatModelingData.verification_answers,
        initial_threats: threatModelingData.initial_threats
      };
      
      // Call the onSubmit callback with this data
      onSubmit(inputs);
    }}
  />
) : (
